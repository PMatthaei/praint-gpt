...
<aside id="default-sidebar"
    ...
    <div on:click|self={toggleSidebar} class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
                ...
                {#if $page.data.session?.user}
                    <div class="flex grow flex-col gap-2">
                        <div class="relative w-12 h-12">
                            <object title="Profilbild" data="https://stackoverflow.com/does-not-exist.png"
                                    type="image/png">
            ...
            <li>
                <a aria-current={$page.url.pathname === '/moti' ? 'page' : undefined}
                ...
                <a aria-current={$page.url.pathname === '/flatjoke' ? 'page' : undefined}
                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                   href="/flatjoke">
                    ...
                    <span class="ml-3">Flat Joke Earth</span>
                </a>
            </li>
